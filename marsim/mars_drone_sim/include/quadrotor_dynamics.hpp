...
void quadrotor_dynamics::step_forward(double dt)
{
    ...
    Torque_body = torque_temp - k_T * motorRPM(0) * motorRPM(0) * z_body - k_T * motorRPM(1) * motorRPM(1) * z_body + k_T * motorRPM(2) * motorRPM(2) * z_body + k_T * motorRPM(3) * motorRPM(3) * z_body;
