...
int main(int argc, char **argv)
{
    ...
    ros::Publisher init_odom_pub = n.advertise<nav_msgs::Odometry>("init_odom", 100);
    ...
    while (n.ok())
    {
        ...
        // publish odometry
        nav_msgs::Odometry odom, init_odom;
        ...
        init_odom = odom;
        init_odom.pose.pose.position.x = init_x;
        init_odom.pose.pose.position.y = init_y;
        init_odom.pose.pose.position.z = init_z;
        init_odom.pose.pose.orientation.w = init_q.w();
        init_odom.pose.pose.orientation.x = init_q.x();
        init_odom.pose.pose.orientation.y = init_q.y();
        init_odom.pose.pose.orientation.z = init_q.z();
        init_odom.twist.twist.linear.x = 0;
        init_odom.twist.twist.linear.y = 0;
        init_odom.twist.twist.linear.z = 0;
        init_odom.twist.twist.angular.x = 0;
        init_odom.twist.twist.angular.y = 0;
        init_odom.twist.twist.angular.z = 0;
