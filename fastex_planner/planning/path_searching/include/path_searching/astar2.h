...
namespace fast_planner
{
  ...
  public:
    ...
    void init(const ros::NodeHandle &nh, const EDTEnvironment::Ptr &env);
    void reset();
    int search(const Eigen::Vector3d &start_pt, const Eigen::Vector3d &end_pt, bool optimistic = true);
    int boundedSearch(const Eigen::Vector3d &start_pt, const Eigen::Vector3d &end_pt,
                      const Eigen::Vector3d &min_bound, const Eigen::Vector3d &max_bound, bool optimistic = true);
